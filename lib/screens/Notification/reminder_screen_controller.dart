...
import 'package:motivation/screens/Notification/notification_integration.dart';
...
class ReminderController extends ChangeNotifier {
  ...
  Future<List<String>> getAllCategories() async {
    return await _quoteIntegration.getAllCategories();
  }
  ...
  void setNotificationSound(int notiSound) {
    _notificationSetting!.notiSoundId = notiSound;
    notifyListeners();
  }
